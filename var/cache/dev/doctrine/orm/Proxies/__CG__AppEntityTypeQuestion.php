 ...
 */
class TypeQuestion extends \App\Entity\TypeQuestion implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TypeQuestion $proxy) {
     ...
     * {@inheritDoc}
     */
    public function addQuestion(\App\Entity\Question $question): \App\Entity\TypeQuestion
    {
     ...
     * {@inheritDoc}
     */
    public function removeQuestion(\App\Entity\Question $question): \App\Entity\TypeQuestion
    {
