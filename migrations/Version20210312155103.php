 ...
 */
final class Version20210312155103 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE matiere CHANGE libelle_matiere libelle_matiere VARCHAR(100) NOT NULL');
        $this->addSql('ALTER TABLE thematique ADD libelle_thematique VARCHAR(100) NOT NULL, DROP libelle_t');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE matiere CHANGE libelle_matiere libelle_matiere VARCHAR(60) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('ALTER TABLE thematique ADD libelle_t VARCHAR(60) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`, DROP libelle_thematique');
    }
}
